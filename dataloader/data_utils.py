...
def get_base_dataloader(args):
    txt_path = "PATH/CEC-CVPR2021/data/index_list/" + args.dataset + "/session_" + str(0 + 1) + '.txt'
...
def get_new_dataloader(args,session):
    txt_path = "PATH/CEC-CVPR2021/data/index_list/" + args.dataset + "/session_" + str(session + 1) + '.txt'
    if args.dataset == 'cifar100':
